...
# This is the Calculator module, it consists of the add() method which takes the input string
# and returns the expected output. Ex: add("1,2") will return 3
...
module Calculator
    ...
    def self.add(input_string)
        ...
        # If the input string matches the regex, it proceeds with the calculation
        ...
        # If the input string doesn't match the regex
        else
            puts "Does not match"
        end
    end
